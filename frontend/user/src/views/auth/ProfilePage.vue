<template>
  <div class="profile my-5">
    <form class="form" @submit.prevent="onSubmit">
      ...
      <div class="mb-3 form-group">
        <label for="maximumNumberOfBooksBorrowed" class="form-label">Số sách được mượn tối đa: </label>
        <input
          type="text"
          id="maximumNumberOfBooksBorrowed"
          class="form-control"
          v-model="data.maximumNumberOfBooksBorrowed"
          disabled
        />
      </div>

      <div class="mb-3 form-group">
        <label for="currentNumberOfBooksBorrowed" class="form-label">Số sách đang mượn: </label>
        <input
          type="text"
          id="currentNumberOfBooksBorrowed"
          class="form-control"
          v-model="data.currentNumberOfBooksBorrowed"
          disabled
        />
      </div>
  ...
  setup() {
    ...
    const onSubmit = async () => {
      ...
      try {
        ...
        // Gọi API update
        const response = await readerService.update(data._id, updatedData);
